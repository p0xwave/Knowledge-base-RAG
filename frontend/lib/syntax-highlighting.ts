...
export const KEYWORDS: Record<string, RegExp> = {
  javascript:
    /\b(const|let|var|function|return|if|else|for|while|do|switch|case|break|continue|new|class|extends|import|export|from|default|async|await|try|catch|finally|throw|typeof|instanceof|in|of)\b/,
  typescript:
    /\b(const|let|var|function|return|if|else|for|while|do|switch|case|break|continue|new|class|extends|import|export|from|default|async|await|try|catch|finally|throw|typeof|instanceof|in|of|type|interface|enum|implements|private|public|protected|readonly|static|abstract|as|is)\b/,
  python:
    /\b(def|class|if|elif|else|for|while|try|except|finally|with|return|import|from|as|pass|break|continue|raise|yield|lambda|and|or|not|in|is)\b/,
...
export const BUILTINS: Record<string, RegExp> = {
  javascript:
    /\b(console|Math|Array|Object|String|Number|Boolean|Date|JSON|Promise|Map|Set|RegExp|Error|parseInt|parseFloat|isNaN|isFinite)\b/,
  typescript:
    /\b(console|Math|Array|Object|String|Number|Boolean|Date|JSON|Promise|Map|Set|RegExp|Error|Record|Partial|Required|Pick|Omit|Exclude|Extract)\b/,
